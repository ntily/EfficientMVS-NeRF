...
parser.add_argument('--testpath', default="/home/nati/dataset/dtu_test",help='test datapath')
...
parser.add_argument('--loadckpt', default='./rc-mvsnet1/model_000010_cas.ckpt', help='load a specific checkpoint')
