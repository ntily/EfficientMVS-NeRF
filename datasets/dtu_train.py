...
class MVSDataset(Dataset):
    ...
    def read_depth_all(self, filename):
        depth_h = np.array(read_pfm(filename)[0], dtype=np.float32)  # (800, 800) edit: I think it is ratehr (1200, 1600)
    ...
    def __getitem__(self, idx):
        ...
        for i, vid in enumerate(view_ids):
            ...
            # Projection matrix from world coordinate system to each view's coordinate system
            ...
            if i == 0:  # reference view
                ...
                # relative projection matrix between reference view and source views
                proj_mats += [proj_mat_ls @ ref_proj_inv]

            if os.path.exists(depth_filename_hr):
                depth_h = self.read_depth_all(depth_filename_hr)    # I don't understand why we need this
            ...
            # I don't think this is necessary since we can get them from the matrices we built in build_proj_mats() method
