...
#             Conv2d(base_channels, base_channels, 3, 1, padding=1),
#         )
#         self.backbone = timm.create_model('efficientnet_b4', pretrained=True, features_only=True,  in_chans=8)
#         self.toplayer = nn.Conv2d(448, 32, 1)
#         self.lat4 = nn.Conv2d(160, 32, 1)
#         self.lat3 = nn.Conv2d(56, 32, 1)
#         self.lat2 = nn.Conv2d(32, 32, 1)
#         self.lat1 = nn.Conv2d(24, 32, 1)
...
#         feat5 = self.toplayer(c4)
#         feat4 = self._upsample_add(feat5,self.lat4(c3))
#         feat3 = self._upsample_add(feat4,self.lat3(c2))
#         feat2 = self._upsample_add(feat3,self.lat2(c1))
#         feat1 = self._upsample_add(feat2,self.lat1(c0))
#         feat0 = self._upsample_add(feat1,self.lat0(x))
...
class CostRegNet(nn.Module):
    def __init__(self, in_channels, norm_act=nn.BatchNorm3d,base_channels=4):
